...
// Présentée comme une vraie fenêtre d'application (chrome + URL) pour
// donner un aperçu produit crédible et professionnel.
export function LandingHeroDashboard() {
  return (
    <div className="landing-fade-up landing-delay-4 landing-dashboard">
      {/* Barre de fenêtre */}
      <div className="landing-dashboard-chrome">
        <span className="landing-chrome-dot" style={{ background: "#FF5F57" }} />
        <span className="landing-chrome-dot" style={{ background: "#FEBC2E" }} />
        <span className="landing-chrome-dot" style={{ background: "#28C840" }} />
        <span className="landing-chrome-pill">
          <span style={{ fontSize: 10 }}>🔒</span> app.edugest — Tableau de bord
        </span>
      ...
      <div style={{ padding: "18px 18px 20px" }}>
        <div className="landing-dashboard-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, borderBottom: "1px solid rgba(255,255,255,0.08)", paddingBottom: 14, marginBottom: 16, position: "relative" }}>
          ...
          <span style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "rgba(0,196,140,0.10)", border: "1px solid rgba(0,196,140,0.28)", borderRadius: 20, padding: "5px 12px", flexShrink: 0 }}>
            <span className="landing-ticker" style={{ width: 6, height: 6, borderRadius: "50%", background: "#00C48C", display: "inline-block" }} />
            <span style={{ fontSize: 11, fontWeight: 800, color: "#2BD9A5", letterSpacing: "0.5px" }}>En direct</span>
          </span>
        </div>
            ...
            <div className="landing-grid-chip" style={{ textAlign: "left" }}>
              ...
              <div style={{ marginTop: 14 }}>
                <div style={{ display: "flex", justifyContent: "space-between", fontSize: 11, marginBottom: 6 }}>
                  <span style={{ color: "rgba(255,255,255,0.55)", fontWeight: 700 }}>Taux de paiement</span>
                  <strong style={{ color: "#00C48C" }}>86%</strong>
                </div>
                <div className="landing-progress"><span style={{ width: "86%" }} /></div>
              </div>
            </div>
