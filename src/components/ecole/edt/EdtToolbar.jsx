...
export function EdtToolbar({ h, maxNote, canCreate, setFiltreClasse, setEdtDuree, edtDuree }) {
  ...
  return (
    <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 14, flexWrap: "wrap" }}>
      ...
      {h.classeEdtActuelle !== "all" && <Btn sm v="ghost" onClick={() => imprimerEDT({ emploisClasse: h.emploisClasse, TRANCHES: h.TRANCHES_IMPRESSION, classeEdtActuelle: h.classeEdtActuelle, schoolInfo: h.schoolInfo, findEns: h.findEns, jours: h.jours })}>🖨️ Imprimer</Btn>}
