...
// dans useEcole (objet `e`) ; ce composant ne fait que router et passer les props.
export function EcoleTabContent({ e, avecEns, userRole, annee, classesPredefinies, maxNote, matieresPredefinies, readOnly, cleEns, cleNotes, cleEleves, couleur }) {
  return (
    <>
      {/* ── APERÇU ── */}
