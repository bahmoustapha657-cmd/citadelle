...
function Comptabilite({ readOnly, annee, userRole, permissions = null, verrouOuvert = false, auteur = "" }) {
  const { t } = useTranslation();
  const c = useComptabilite({ readOnly, annee, userRole, permissions, verrouOuvert, auteur });
