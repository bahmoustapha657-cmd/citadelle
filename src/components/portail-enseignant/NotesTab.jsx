...
// Onglet "Notes" du Portail Enseignant.
// Affiche la liste des notes pour la période, et 2 modales d'édition :
// - Création/édition unitaire (formNote)
// - Grille de saisie en masse pour une classe entière (gridForm).
export function NotesTab({
  // État + actions du parent
  c1,
  matiere,
  schoolInfo,
  utilisateur,
